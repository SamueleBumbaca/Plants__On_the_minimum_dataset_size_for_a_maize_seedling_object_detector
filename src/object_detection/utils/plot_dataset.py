...
def plot_bounding_boxes(dataset, ids_perc, cfg):
    ...
    if dataset == 'train':
        ...
        raise ValueError(f"Dataset must be 'train', 'val', or 'test', while it is {dataset}")

    print(f"Plotting bounding boxes for {dataset} dataset")
    print(f"Configuration file: {cfg}")
...
if __name__ == "__main__":
    # Example usage
    dataset = 'train'  # 'train', 'val', or 'test'
