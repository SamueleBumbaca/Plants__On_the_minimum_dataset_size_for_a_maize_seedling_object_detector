...
# datasets_name = ('DIOR', 'FISH', 'NEUDET', 'UODD')
datasets_name = ('1', '2', '3')

CLASS_NAME = {
    'ArTaxOr_classes': ['Araneae', 'Coleoptera', 'Diptera', 'Hemiptera', 'Hymenoptera', 'Lepidoptera', 'Odonata'],
    'clipart1k_classes': ['sheep', 'chair', 'boat', 'bottle', 'diningtable', 'sofa', 'cow', 'motorbike', 'car', 'aeroplane', 'cat', 'train', 'person', 'bicycle', 'pottedplant', 'bird', 'dog', 'bus', 'tvmonitor', 'horse'],
    'DIOR_classes': ['Expressway-Service-area','Expressway-toll-station','airplane','airport','baseballfield','basketballcourt','bridge','chimney','dam', 'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill'],
    'FISH_classes': ['fish'],
    'NEUDET_classes': ['crazing', 'inclusion', 'patches', 'pitted_surface', 'rolled-in_scale', 'scratches'],
    'UODD_classes': ['seacucumber', 'seaurchin', 'scallop'],
    '1_classes': ['object'],
    '2_classes': ['object'],
    '3_classes': ['object'],
}
...
for dataset in datasets_name:
    ...
    globals()[f'{dataset}_30SHOT'] = f'{dataset}_30shot'
    globals()[f'{dataset}_50SHOT'] = f'{dataset}_50shot'

    SEEN_CLS_DICT[f'{dataset}_train'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_test'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_1shot'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_5shot'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_10shot'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_30shot'] = CLASS_NAME[f'{dataset}_classes']
    SEEN_CLS_DICT[f'{dataset}_50shot'] = CLASS_NAME[f'{dataset}_classes']

    ALL_CLS_DICT[f'{dataset}_train'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_test'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_1shot'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_5shot'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_10shot'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_30shot'] = CLASS_NAME[f'{dataset}_classes']
    ALL_CLS_DICT[f'{dataset}_50shot'] = CLASS_NAME[f'{dataset}_classes']
