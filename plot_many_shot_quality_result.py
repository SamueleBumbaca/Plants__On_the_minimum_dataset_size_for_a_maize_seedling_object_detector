...
def main():
    # Define model and image pairs for dataset quality experiments
    predictions_config = [
        {
            'model_path': 'experiments/models/dataset_quality/rtdetr-x_dataset_2_exp_dataset_quality_254',
            'image_path': 'dataset/2/yolo_datasets/DatasetSize_10_Train_9_Val_1/val/SAGIT22_C_4178_2022_04_29-34-14.tif',
            'title': 'Dataset 2 - RT-DETR-X (Quality Exp 254)'
        },
        {
            'model_path': 'experiments/models/dataset_quality/rtdetr-x_dataset_3_exp_dataset_quality_273',
            'image_path': 'dataset/3/yolo_datasets/DatasetSize_10_Train_9_Val_1/val/SAGIT22_C_4178_2022_05_10-51-27.tif',
            'title': 'Dataset 3 - RT-DETR-X (Quality Exp 273)'
        },
        {
            'model_path': 'experiments/models/dataset_quality/rtdetr-x_dataset_1_exp_dataset_quality_235',
            'image_path': 'dataset/1/yolo_datasets/DatasetSize_10_Train_9_Val_1/val/SAGIT22_C_4175_2022_05_27-39-14.tif',
            'title': 'Dataset 1 - RT-DETR-X (Quality Exp 235)'
        }
    ]
    ...
    pdf_path = output_dir / 'rtdetr_x_dataset_quality_predictions.pdf'
    ...
    for idx, config in enumerate(predictions_config):
        try:
            ...
            output_file = output_dir / f"dataset_quality_prediction_{idx+1}.pdf"
