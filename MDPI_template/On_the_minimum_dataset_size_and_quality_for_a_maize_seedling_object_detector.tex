...
\Title{On the minimum dataset requirements to fine-tune an object detector for arable crops plant counting:
A downstream case study on maize seedlings}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Title}

% Author Orchid ID: enter ID or remove command
\newcommand{\orcidauthorA}{https://orcid.org/0009-0002-5482-8375} % Add \orcidA{} behind the author's name
\newcommand{\orcidauthorB}{https://orcid.org/0000-0003-4570-8013} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Samuele Bumbaca $^{1}$*\orcidA{} and Enrico Borgogno-Mondino $^{1}$\orcidB{}}
% \Author{Firstname Lastname $^{1,\dagger,\ddagger}$\orcidA{}, Firstname Lastname $^{2,\ddagger}$ and Firstname Lastname $^{2,}$*}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Samuele Bumbaca and Enrico Borgogno-Mondino}
...
\address{
$^{1}$ \quad Department of Agricultural, Forest and Food Sciences, University of Turin, 10095 Grugliasco, Italy
}

% Contact information of the corresponding author
\corres{Correspondence: samuele.bumbaca@unito.it}
...
\keyword{object detection; maize seedling counting; dataset requirements; transformer models; 
precision agriculture; annotation quality; few-shot learning; orthomosaic imagery; 
...
Complete algorithm pseudocodes are provided in the appendix.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, Samuele Bumbaca and Enrico Borgogno-Mondino; 
methodology,Samuele Bumbaca and Enrico Borgogno-Mondino;
software, Samuele Bumbaca; 
validation, Samuele Bumbaca; 
formal analysis, Samuele Bumbaca; 
investigation, Samuele Bumbaca; 
resources,Samuele Bumbaca and Enrico Borgogno-Mondino; 
data curation, Samuele Bumbaca; 
writing---original draft preparation, Samuele Bumbaca; 
writing---review and editing, Enrico Borgogno-Mondino; 
visualization, Samuele Bumbaca; 
supervision, Enrico Borgogno-Mondino; 
project administration, Enrico Borgogno-Mondino;
funding acquisition, Samuele Bumbaca and Enrico Borgogno-Mondino. 
...
\dataavailability{The code for all models training and handcrafted methods used 
in this study is available at \url{https://github.com/SamueleBumbaca/plant_count.git}. 
The datasets created during this study (ID datasets) are available from the corresponding 
author upon reasonable request. The other datasets used are available from their 
cited sources.}
