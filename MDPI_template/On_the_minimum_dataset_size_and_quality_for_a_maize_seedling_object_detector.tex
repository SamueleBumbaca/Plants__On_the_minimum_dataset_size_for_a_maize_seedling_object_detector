...
\cite{davidPlantDetectionCounting2021,andvaagCountingCanolaGeneralizable2024}, and only one
specifically tried to minimize the size of the training dataset to 600 512*512 RGB images \cite{karamiAutomaticPlantCounting2020}.
...
object detector is the dataset source CiteHere . It has been observed that using training samples from the same
