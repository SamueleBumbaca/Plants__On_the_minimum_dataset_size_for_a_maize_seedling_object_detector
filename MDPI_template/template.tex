...
Using georeferenced orthomosaics in maize seedling counting makes both HC and DL 
object detection easier, 
...
and Transformer-based approaches (e.g., DETR, ViT). 
To effectivelly detect, these models must be trained 
on large-scale annotated datasets to learn to detect objects
